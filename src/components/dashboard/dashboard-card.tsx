...
export const DashboardCard = ({ base }: DashboardCardProps) => {
  return (
    <Link href={`/base/${base.id}`}>
      <div className="flex h-[92px] w-full cursor-pointer items-center justify-center rounded-[6px] border bg-white hover:bg-gray-50">
        ...
        <div className="mr-4 flex flex-auto flex-col items-start justify-center">
          <h3 className="truncate text-[13px] font-medium">{base.name}</h3>
